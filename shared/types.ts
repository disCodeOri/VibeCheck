...
export interface Profile { name: string; mood: string; presentation: 'masculine' | 'feminine' | 'neutral'; avatar: AvatarParams; photo?: string; bodyPhoto?: string; consent: boolean; onboardingDone: boolean }
